...
- **Viewer:** `https://anywr.me/<username>#browser` (noVNC at `/view/*`, authorised by the session cookie)
...
| `chrome/` | The per-user browser image (`anywr-chrome`): Chrome + Xvfb + noVNC, CDP re-exported on :9223. |
